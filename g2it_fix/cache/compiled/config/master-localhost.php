...
return [
    ...
    'timestamp' => 1633959845,
    'checksum' => '3510a823d4bbd69da3123b685bc445cd',
    'files' => [
        'user/config' => [
            'backups' => [
            ...
            'plugins/stripe' => [
                'file' => 'user/config/plugins/stripe.yaml',
                'modified' => 1633959747
            ],
            'scheduler' => [
            ...
            'themes/g2it' => [
                'file' => 'user/config/themes/g2it.yaml',
                'modified' => 1633959747
            ],
            'versions' => [
        ...
        'user/plugins' => [
            ...
            'plugins/stripe' => [
                'file' => 'user/plugins/stripe/stripe.yaml',
                'modified' => 1633959751
            ],
        ...
        'user/themes' => [
            'themes/g2it' => [
                'file' => 'user/themes/g2it/g2it.yaml',
                'modified' => 1633959751
            ],
            'themes/quark' => [
    ...
    'data' => [
        'themes' => [
            'g2it' => [
                ...
                'logo' => 'g2itlogo.png',
                'favicon' => 'favicon.png',
                'favicon_apple' => 'apple-icon.png',
                'favicon_72' => 'apple-icon-72x72.png',
                'favicon_144' => 'apple-touch-icon-114x114.png',
                'short_description' => 'Our focus is to deliver high quality IT solutions, on time, every time. Our aim is to make your IT systems work for you, so that you can focus your energy where it is most needed...',
                'communications' => [
                    'headline' => 'IT Services',
                    'items' => [
                        0 => [
                            'content' => '1300 325 487'
                        ],
                        1 => [
                            'content' => 'info@g2it.com.au'
                        ],
                        2 => [
                            'content' => '08 9335 5478'
                        ]
                    ],
                    'hotline' => '1300 325 487',
                ...
                'info' => [
                    ...
                    'items' => [
                        ...
                        2 => [
                            'label' => 'Client Login',
                            'url' => 'https://cw.g2it.com.au/support'
                        ],
                        3 => [
                            'label' => 'Remote Support',
                            'url' => 'https://g2it.screenconnect.com/'
                        ],
                        4 => [
                            'label' => 'Book Appointment',
                            'url' => 'https://outlook.office365.com/owa/calendar/G2IT1@g2it.com.au/bookings/'
                        ]
                    ]
                ],
                ...
                'navigation' => [
                    ...
                    2 => [
                        ...
                        'children' => [
                            ...
                            1 => [
                                'url' => '/our-services/cloud-services-fremantle'
                            ],
                            2 => [
                                'url' => '/our-services/virtualisation-solutions'
                            ],
                            3 => [
                                'url' => '/our-services/it-suppport'
                            ],
                            4 => [
                                'url' => '/our-services/managed-it-services'
                            ],
                            5 => [
                                'url' => '/our-services/robo-it-support-perth'
                            ],
                            6 => [
                                'url' => '/our-services/backup-recovery-services-fremantle'
                            ],
                            7 => [
                                'url' => '/our-services/network-and-security-assessments'
                            ],
                            8 => [
                                'url' => '/our-services/cyber-security'
                            ],
                            9 => [
                                'url' => '/our-services/it-maintenance-perth'
                            ],
                            10 => [
                                'url' => '/our-services/it-project-management-perth'
                            ],
                            11 => [
                                'url' => '/our-services/strategy-and-planning'
                            ],
                            12 => [
                                'url' => '/our-services/voip-phone-systems-perth'
                            ],
                            13 => [
                                'url' => '/our-services/commercial-wifi-wireless-networks-perth'
                            ],
                            14 => [
                                'url' => '/our-services/lexmark-printer-servicing-fremantle'
                            ],
                            15 => [
                                'url' => '/our-services/it-procurement-perth'
                            ]
                        ]
                    ],
                    3 => [
                ...
                'facebook' => 'https://www.facebook.com/G2ITAustralia/',
                'linkedin' => 'https://www.linkedin.com/company/14527738/',
                'phone' => '1300325487',
                'popup' => [
                    'title' => 'COVID-19 Update',
                    'content' => 'Our offices in Esperance and Fremantle <br> 
are open for business as usual whilst keeping <br>
 the required COVID safety measures in place. 

You can <br><a href="/tools/book-appointment">**book an appointment. **</a>
<br>Call <a href="tel:1300325487">1300 325 487</a> or [contact us](https://www.g2it.com.au/contact-us).</div>
...
',
        ...
        'plugins' => [
            ...
            'onwebchat' => [
                ...
                'chatid' => '70d8681a66958f4cb455891078ae19d6',
                'default_active' => true
            ],
            'pagination' => [
                'enabled' => true,
            ...
            'stripe' => [
                'enabled' => true,
                'secret_key' => 'sk_live_YkYp1xpYkfE3fYa2icADrY7o00cI1TVQK5',
                'public_key' => 'pk_live_4nHEUsE8WlHBM2EEq5eCBDNf00WqxzYtXP',
                'default_currency' => 'aud',
                'amount_prefix' => '$',
                'amount_postfix' => NULL,
                'payment_description' => 'Payment for invoice INVOICE_NUMBER'
            ],
            'taxonomylist' => [
                'enabled' => true,
                'route' => '/blog'
...
node_modules'
        ...
        'site' => [
            'title' => 'G2IT - IT Support & IT Services in Fremantle, Esperance, Perth',
            'default_lang' => 'en',
            'author' => [
                'name' => 'G2 IT',
                'email' => 'info@g2it.com.au'
            ...
            'metadata' => [
                'description' => 'Our focus is to deliver high quality IT solutions, on time, every time. Our aim is to make your IT systems work for you, so that you can focus your energy where it is most needed',
                'title' => 'G2IT - IT Support Fremantle, Esperance & Perth'
            ],
            'summary' => [
                'enabled' => true,
                'format' => 'short',
            ...
            'core' => [
                'grav' => [
                    ...
                    'history' => [
                        0 => [
                            'version' => '1.7.9',
                            'date' => '2021-03-30 03:31:33'
                        ],
                        1 => [
                            'version' => '1.7.12',
                            'date' => '2021-04-19 06:26:04'
                        ],
                        2 => [
                            'version' => '1.7.22',
                            'date' => '2021-09-22 03:19:52'
                        ],
                        3 => [
                            'version' => '1.7.23',
                            'date' => '2021-10-09 04:56:51'
                        ]
                    ],
