...
return [
    ...
    'filename' => 'C:/xampp/htdocs/g2it_fix/user/pages/06.our-partners/07.trend-micro/partner.md',
    'modified' => 1633959748,
    'data' => [
        'header' => [
            'title' => 'Trend Micro',
...
restaurant:
    acceptsReservations: \'yes\'
    priceRange: $',
        'markdown' => 'In 1988, Trend Micro was co-founded by Steve Chang, Jenny Chang, and Eva Chen to develop antivirus software—but it didn’t stop there. Over the last three decades, we’ve become a market leader in hybrid cloud security, network defence, small business security, and endpoint security.
