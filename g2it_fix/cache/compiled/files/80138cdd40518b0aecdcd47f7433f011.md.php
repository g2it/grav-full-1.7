...
return [
    ...
    'filename' => 'C:/xampp/htdocs/g2it_fix/user/pages/04.our-people/01.vladimir-guiris/member.md',
    'modified' => 1633959748,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Vladimir Guiris\'
media_order: vladimir-guiris.jpg
position: \'Managing Director\'
twittercardoptions: summary
articleenabled: false
...
restaurant:
    acceptsReservations: \'yes\'
    priceRange: $',
        'markdown' => '<p>Vladimir is the G2IT Managing Director. He has been honing his considerable IT and Management skills while working for the company for over a decade.</p>
